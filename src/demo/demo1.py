...
class demo1():
    ...
    def tick(self,t):
        ...
        if t < 20:
            ...
            self.demo_input._params["center"] = imgToFC(self.light_positions[2])
            self.demo_input._params["amplitude"] = 0
        else:
            img.paste(self.light_on, self.light_positions[2], self.light_on)
            self.demo_input._params["center"] = imgToFC(self.light_positions[2])
            self.demo_input._params["amplitude"] = 5
    ...
    def plot(self):
        ...
        for t in range(len(self.recordings)):
            ...
            axes[0][0].imshow(self.recordings[t][0][1], cmap=cmap)
            ...
            axes[1][0].imshow(self.recordings[t][0][3], cmap=cmap)
